...
#Send-MidiControlChangeMessage -Port $outputPort -Channel 0 -Controller 0 -Value $intensity -debug
Send-MidiControlChangeMessage -Port $outputPort -Channel 0 -Controller 0 -Value $intensity
