...
# this is the ID of my launchpad
...
# load the types. This is a hack
#[Windows.Devices.Midi.MidiInPort,Windows.Devices.Midi,ContentType=WindowsRuntime]::GetDeviceSelector() > $null


Send-MidiControlChangeMessage -Port $outputPort -Channel 0 -Controller 0 -Value 64

#Send-MidiNoteOnMessage -Port $outputPort -Channel 0 -Note 64 -Velocity 16
